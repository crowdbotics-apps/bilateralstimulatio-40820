...
## Project Structure
    ...
    ├── bilateralstimulatio_40820  # Django project configurations
...
1. Clone this repo and `cd bilateralstimulatio_40820`
...
2. Clone this repo and `cd bilateralstimulatio_40820`
